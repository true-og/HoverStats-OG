...
public class Messages {
    ...
    public static void reloaded(CommandSender sender) {
        String path = plugin.getConfig()
                .getString(
                        "Messages.System Messages.Success.Reloaded",
    ...
    public static void noPermissions(CommandSender sender) {
        String path = plugin.getConfig()
                .getString(
                        "Messages.System Messages.Error.No Permissions",
    ...
    public static TextComponent papiHookSuccess() {
        String path = plugin.getConfig()
                .getString("Messages.System Messages.Success.PAPI Hook", "&aFound PlaceholderAPI, hooking into it.");
    ...
    public static TextComponent papiHookFailed() {
        String path = plugin.getConfig()
                .getString(
                        "Messages.System Messages.Error.PAPI Hook",
