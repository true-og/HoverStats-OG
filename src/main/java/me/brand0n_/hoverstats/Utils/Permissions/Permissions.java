...
public class Permissions {
    ...
    /**
     * This method will check weather or not the player has a specific permission by
     * checking if the player has a specific permission prefix, followed by the
     * final prefix node. <br />
     * <br />
     * Ex: [permission node].[node] <br />
     * Ex: home.1 <br />
     * <br />
     *
    ...
    public static boolean hasPermission(CommandSender sender, String permission, String node) {
        ...
        // Player didn't have any permission node matching the one provided, return
        // false
        return false;
